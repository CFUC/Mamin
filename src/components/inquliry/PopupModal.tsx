        ...
        <div className={styles.textContent}>
          ...
          <div className={styles.textContentSub}>
            <ul>
              ...
              <li>
                제공하기 위한 목적으로 귀하의 개인정보를 수집ㆍ이용하고
                있습니다.
              </li>
              <li>
          ...
          <div className={styles.textContentSub}>
            <ul>
              ...
              <li>
                모든 정보는 상기 목적에 필요한 용도 이외로는 사용되지 않으며
                수집 정보의 범위나 사용 목적, 용도가 변경될 시에는 반드시
              </li>
          ...
          <div>
            <ul>
              ...
              <li>
                -시용정보의 수집/처리 및 이용 등에 관한 기록 : 3년(신용정보의
                이용 및 보호에 관한 법률)
              </li>
              <li>
